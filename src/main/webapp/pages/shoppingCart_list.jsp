...
<main>
    ...
    <div class="wrapper">
                        ...
                        <div class="table-box">
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="我的购物车" onclick="window.location.href='${pageContext.request.contextPath}/shoppingCart/findAll.do?uid=${user.uid}';"><i class="fa fa-refresh"></i> 我的购物车</button>
                                        <button type="button" class="btn btn-default" title="我的订单" onclick="window.location.href='${pageContext.request.contextPath}/order/findAll/${user.uid}';"><i class="fa fa-refresh"></i> 我的订单</button>
                            ...
                            <c:forEach items="${shoppingCarts}" var="shoppingCart">
                                <tr>
                                    ...
                                    <td><img src="${pageContext.request.contextPath}/${shoppingCart.goods.picNumber}"/> </td>
                                    <td>${shoppingCart.goods.GName}</td>
                                    <td>￥${shoppingCart.goods.price}</td>
                                    <td>${shoppingCart.count}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href = "${pageContext.request.contextPath}/shoppingCart/delete/${shoppingCart.gid}/${shoppingCart.user.uid}";'>删除</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/goods/${shoppingCart.gid}"'>商品详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/order/pay/${shoppingCart.user.uid}/${shoppingCart.gid}/${shoppingCart.count}"'>支付</button>
                                    </td>
                                </tr>
                            </c:forEach>
                            ...
                            <div class="pull-left">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="删除" onclick='""'><i class="fa fa-trash-o"></i> 删除</button>
                                        <button type="button" class="btn btn-default" title="刷新" onclick="window.location.reload();"><i class="fa fa-refresh"></i> 刷新</button>
                                    </div>
                                </div>
                            </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2020-- <a href="#">18软件03研发部</a>.</strong> All rights reserved.
        </footer>
        <!-- 底部导航 /-->
