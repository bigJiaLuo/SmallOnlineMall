        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="all-order-manage-list.html">我的</a></li>
                            ...
                            <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                                ...
                                <c:forEach items="${orderList}" var="order">
                                    <tr>
                                        ...
                                        <td><img src="${pageContext.request.contextPath}/${order.goods.picNumber}"/> </td>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href = "${pageContext.request.contextPath}/order/delete/${order.oid}/${order.user.uid}";'>删除记录</button>
                                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${pageContext.request.contextPath}/goods/${order.goods.gid}"'>商品详情</button>
                                        </td>
                                    </tr>
                                </c:forEach>
